...
object SparkHelper {
  ...
  // SparkContext - An entry point for all Spark services =
  ...
  def createSparkSession: SparkSession = createSparkSession("Spark Clustering Session")
}
